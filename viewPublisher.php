                            ...
                            if(isset($publishers)){
                                foreach($publishers as $publisher){
                                    echo "<tr>
                                        ...
                                        <td><a href='editPublisher.php?bid=$publisher[publisher_id]' class='btn btn-info'>Edit </a></td>
                                        <td><a href='deletePublisher.php?bid=$publisher[publisher_id]' class='btn btn-danger'>Delete </a></td>
                                    </tr>";
                                }
                            }
                        ?>
